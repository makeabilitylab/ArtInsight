...
scores_folder = os.path.join(script_dir, "scores_new")
...
for image_file in image_files:
    ...
    score_file = os.path.join(scores_folder, f"{base_name}-score.txt")
...
# Create DataFrame
columns = ["Image", "New System Prompt"]
...
output_path = os.path.join(script_dir, "Artwork_Description_Scores_New.csv")
